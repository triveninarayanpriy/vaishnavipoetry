        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {poems.length > 0 ? (
            ...
            <div className="col-span-full text-center py-20">
              <p className="text-soil text-lg">No poems found. Check back soon!</p>
            </div>
          )}
        </div>
        ...
        >
          <Link href="/">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="px-6 py-3 bg-transparent border-2 border-soil hover:border-earth text-soil hover:text-earth font-sans font-medium rounded-full transition-all duration-300"
            >
              ← Back to Home
            </motion.button>
          </Link>
