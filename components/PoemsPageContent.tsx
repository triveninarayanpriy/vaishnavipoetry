    ...
    <div className="min-h-screen bg-gradient-to-br from-cream via-parchment to-sage/10">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="font-sans text-lg text-soil max-w-2xl mx-auto">
            ...
            >
              <Link href={`/poems/${poem.slug}`}>
                <motion.article
                  ...
                  className={`${poem.background || 'bg-parchment'} rounded-lg p-8 shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer border border-clay/20 h-full`}
                  style={{
                ...
                >
                  ...
                  <h2 className="font-serif text-3xl text-earth mb-4">
                    {poem.title}
                  </h2>
                  
                  <p className="font-serif text-lg text-charcoal/80 italic leading-relaxed mb-4">
                    {poem.excerpt}
                  </p>
